...
import { LLMSummarizeNodeProps } from "./typedef";
import Main from ".";
 ...
 * @returns 
 */
export default function LLMSummarizeNode(props: LLMSummarizeNodeProps): React.ReactNode {
    ...
    const handles: NodeHandleProps[] = [
        ...
        { type: "source", datatype: "prompt", shift: p3, id: "prompt", maxConnections: 1 },
    ]
