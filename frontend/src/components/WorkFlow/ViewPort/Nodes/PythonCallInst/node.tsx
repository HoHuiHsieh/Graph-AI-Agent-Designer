...
import BaseNode, { NodeHandleProps } from "../BaseNode";
import { PythonCallInstNodeProps } from "./typedef";
 ...
 * @returns 
 */
export default function PythonCallInstNode(props: PythonCallInstNodeProps): React.ReactNode {
    ...
    const handles: NodeHandleProps[] = [
        ...
        { type: "source", datatype: "instruction", shift: p0, id: "instruction", maxConnections: 100 },
    ]
