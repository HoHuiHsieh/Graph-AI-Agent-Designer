...
import { PythonRunSystNodeProps, schema } from "./typedef";
import { useWorkSpace } from "@/components/WorkFlow/provider";
import Main from ".";


/**
 * Python run script component
 * @param props
 * @returns
 */
export default function PythonRunSystForm(
    props: Node & { data: PythonRunSystNodeProps["data"] }
): React.ReactNode {
