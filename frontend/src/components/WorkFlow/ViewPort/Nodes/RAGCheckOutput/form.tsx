...
import { Divider, Typography, TextField, Stack, Autocomplete, Tooltip, IconButton, MenuItem, Box, Tab, Paper, FormControlLabel, Switch } from "@mui/material";
...
import { schema, RAGCheckOutputNodeProps, seperators } from "./typedef";
import Main from ".";
...
/**
 * RAG check output component
 * @param props
 * @returns
 */
export default function RAGCheckOutputForm(
    props: Node & { data: RAGCheckOutputNodeProps["data"] }
): React.ReactNode {
    ...
    // handle state
    const formik = useFormik<RAGCheckOutputNodeProps["data"]>({
        initialValues: {
            ...defaultData,
            ...(ConvRAGData.decode(props.data, defaultData["documents"]) as RAGCheckOutputNodeProps["data"] || {}),
            id: props.id,
        },
        ...
        (event) => {
            ...
            getSimpleRAG.build({
                ...
                .then(() => {
                    ...
                    }, tmp["documents"]) as RAGCheckOutputNodeProps["data"];
