...
import { schema, RAGSimpleFuncNodeProps, seperators } from "./typedef";
import Main from ".";
...
/**
 * RAG function call component
 * @param props
 * @returns
 */
export default function RAGSimpleFuncForm(
    props: Node & { data: RAGSimpleFuncNodeProps["data"] }
): React.ReactNode {
    ...
    // handle state
    const formik = useFormik<RAGSimpleFuncNodeProps["data"]>({
        initialValues: {
            ...defaultData,
            ...(ConvRAGData.decode(props.data, defaultData["documents"]) as RAGSimpleFuncNodeProps["data"] || {}),
            id: props.id,
        },
    ...
    const handleAppendDocument: React.MouseEventHandler<HTMLButtonElement> = useCallback(
        (event) => {
            ...
            data.push(defaultData.documents[0]);
            formik.setFieldValue("documents", data);
        },
        [formik]
    )
            ...
            getSimpleRAG.build({
                ...
                .then(() => {
                    ...
                    let props = ConvRAGData.decode({
                        ...
                        documents: info.documents.map(e => ({ text: e, function: "" })) || [],
                        parameters: {
                    ...
                    }, tmp["documents"]) as RAGSimpleFuncNodeProps["data"];
        ...
        >
            ...
            <TabContext value={value} >
                ...
                >
                    ...
                    >
                        {formik.values.documents.map((doc, index: number) => (
                            <Grid key={index}
                                container
                                ...
                                <Grid size={10}>
                                    ...
                                    >
                                        ...
                                        <TextField
                                            ...
                                            maxRows={6}
                                            value={doc.function}
                                            onChange={(e) => handleChangeFunction(e, index)}
                                            error={Array.isArray(formik.errors.documents) ? Boolean(formik.errors.documents[index]) : Boolean(formik.errors.documents)}
                                            helperText={Boolean(formik.errors.documents) && "Not a valid JSON string"}
                                            slotProps={{
                                                htmlInput:{
                                                    style:{
                                                        backgroundColor: "FFF",
