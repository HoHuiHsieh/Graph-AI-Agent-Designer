...
import { RAGSimpleFuncNodeProps } from "./typedef";
import Main from ".";


/**
 * RAG function calling node
 * @param props 
 * @returns 
 */
export default function RAGSimpleFuncNode(props: RAGSimpleFuncNodeProps): React.ReactNode {
    // Add connection handler
    let p0 = getConnectionHandlePosition(1, 0),
        p1 = getConnectionHandlePosition(1, 0);
    const handles: NodeHandleProps[] = [
        { type: "source", datatype: "function", shift: p1, id: "function", maxConnections: 100 },
    ...
    const isValid = Boolean(
        ...
        !data.documents.some(e => !e.text || !e.function)
    );
