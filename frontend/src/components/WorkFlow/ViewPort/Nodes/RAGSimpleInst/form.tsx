...
import { schema, RAGSimpleInstNodeProps, seperators } from "./typedef";
import Main from ".";
 ...
 * @returns
 */
export default function RAGSimpleInstForm(
    props: Node & { data: RAGSimpleInstNodeProps["data"] }
): React.ReactNode {
    ...
    // handle state
    const formik = useFormik<RAGSimpleInstNodeProps["data"]>({
        initialValues: {
            ...defaultData,
            ...(ConvRAGData.decode(props.data, defaultData["documents"]) as RAGSimpleInstNodeProps["data"] || {}),
            id: props.id,
        },
        ...
        (event) => {
            ...
            getSimpleRAG.build({
                ...
                .then(() => {
                    ...
                    }, tmp["documents"]) as RAGSimpleInstNodeProps["data"];
