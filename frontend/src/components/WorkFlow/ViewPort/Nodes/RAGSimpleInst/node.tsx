...
import { RAGSimpleInstNodeProps } from "./typedef";
import Main from ".";
 ...
 * @returns 
 */
export default function RAGSimpleInstNode(props: RAGSimpleInstNodeProps): React.ReactNode {
    // Add connection handler
    let p0 = getConnectionHandlePosition(1, 0),
        p1 = getConnectionHandlePosition(1, 0);
    const handles: NodeHandleProps[] = [
        { type: "source", datatype: "instruction", shift: p1, id: "instruction", maxConnections: 100 },
