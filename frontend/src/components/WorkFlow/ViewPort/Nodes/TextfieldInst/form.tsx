...
import { TextfieldInstNodeProps, schema } from "./typedef";
import Main from ".";
 ...
 * @returns
 */
export default function TextfieldInstForm(
  props: Node & { data: TextfieldInstNodeProps["data"] }
): React.ReactNode {
  const { setNodes } = useReactFlow();

  // handle state
  const formik = useFormik<TextfieldInstNodeProps["data"]>({
    initialValues: {
      ...schema.getDefault(),
      ...props.data,
    },
